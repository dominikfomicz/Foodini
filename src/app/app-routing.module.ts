...
const routes: Routes = [
	...
	{ path: '', loadChildren: './pages/home-results/home-results.module#HomeResultsPageModule', canActivate: [AuthGuard] },
	...
	{ path: 'local-coupons-card/:id_local_data_main', loadChildren: './pages/local-coupons-card/local-coupons-card.module#LocalCouponsCardPageModule', canActivate: [AuthGuard] },
